...
```
# Инструкция по работе с программой генерации данных

> **Примечание:**  
> При запуске программа попросит указать количество создаваемых записей для каждой таблицы.  
> **Рекомендуется просто нажать `ENTER`**, чтобы использовать параметры по умолчанию.
